 ...
 */
class Dimension extends Model { protected $table='accounting_dimensions'; protected $fillable=['code','name','kind','description','is_required','is_active','metadata']; protected $casts=['kind'=>DimensionKind::class,'is_required'=>'bool','is_active'=>'bool','metadata'=>'array']; /** @return HasMany<DimensionValue, $this> */ public function values():HasMany{return $this->hasMany(DimensionValue::class);} }
