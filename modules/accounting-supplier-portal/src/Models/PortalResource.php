 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, PortalDocument> $documents
 */
final class PortalResource extends Model
{
    ...
    public function documents(): HasMany { return $this->hasMany(PortalDocument::class,'resource_id'); }
    public function scopeForSupplier(Builder $query, string $supplierId): Builder { return $query->where('supplier_id',$supplierId); }
}
