 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, TaxEvidence> $evidence
 */
final class TaxRule extends Model
{
    ...
    public function evidence(): HasMany { return $this->hasMany(TaxEvidence::class, 'tax_rule_id'); }
