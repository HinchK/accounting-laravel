 ...
 * @property \Illuminate\Support\Carbon|null $as_of_date
...
final class RevaluationRun extends Model
{
    ...
    public function positions(): HasMany { return $this->hasMany(RevaluationPosition::class, 'run_id'); }
    public function reconciliations(): HasMany { return $this->hasMany(CurrencyReconciliation::class, 'run_id'); }
}
