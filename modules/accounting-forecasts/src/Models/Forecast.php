...
final class Forecast extends Model
{
    ...
    /** @return HasMany<ForecastAssumption, $this> */ public function assumptions(): HasMany { return $this->hasMany(ForecastAssumption::class, 'forecast_id'); }
    /** @return HasMany<ForecastApproval, $this> */ public function approvals(): HasMany { return $this->hasMany(ForecastApproval::class, 'forecast_id'); }
    /** @return HasMany<ForecastPeriod, $this> */ public function periods(): HasMany { return $this->hasMany(ForecastPeriod::class, 'forecast_id'); }
    /** @return HasMany<ForecastActual, $this> */ public function actuals(): HasMany { return $this->hasMany(ForecastActual::class, 'forecast_id'); }
}
