...
final class SettlementRun extends Model
{
    ...
    public function items(): HasMany { return $this->hasMany(SettlementItem::class,'run_id'); }
    public function exceptions(): HasMany { return $this->hasMany(ReconciliationException::class,'run_id'); }
    public function drifts(): HasMany { return $this->hasMany(ProviderDrift::class,'run_id'); }
    public function audits(): HasMany { return $this->hasMany(AuditEvidence::class,'run_id'); }
}
