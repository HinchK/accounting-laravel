...
use Liberu\Accounting\PaymentReconciliation\Enums\{SettlementItemStatus,SettlementItemType};
/**
 * @property int $id
 * @property int $run_id
...
final class SettlementItem extends Model
{
    ...
    public function matches(): HasMany { return $this->hasMany(SettlementMatch::class,'item_id'); }
    public function amount(): float { return round((float)$this->net_amount,2); }
}
