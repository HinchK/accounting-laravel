...
final class DimensionsLivewireServiceProvider extends ServiceProvider { public function boot():void{Livewire::component('accounting-dimensions',Dimensions::class);} }
