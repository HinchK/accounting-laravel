...
<header class="nav" id="nav">
    <div class="wrap nav__inner">
        ...
        <nav class="nav__links" aria-label="Primary">
            ...
            <a href="https://github.com/liberusoftware/accounting-erp-laravel" class="muted" rel="noopener">GitHub</a>
            @if (Route::has('login'))
        ...
        <div class="wrap hero__grid">
            <div>
                ...
                <div class="hero__cta reveal" data-d="3">
                    ...
                    @endif
                    <a href="https://github.com/liberusoftware/accounting-erp-laravel" class="btn btn--ghost" rel="noopener">
            ...
            <div class="reveal" data-d="4">
                <div class="mock" role="img" aria-label="The accounting ERP's team messaging screen in the Clear Signal teal theme: a sidebar with Dashboard, Teams, Messages and Settings, beside a team conversation.">
                    <div class="mock__bar">
        ...
        <div class="wrap">
            ...
            <div class="features">
                ...
                <div class="feature feature--cta">
                    <a href="https://github.com/liberusoftware/accounting-erp-laravel" rel="noopener">
                        Read the source
        ...
        <div class="wrap theming__grid">
            <div>
                <div class="section-head">
                    ...
                    <p>The accounting ERP ships its own design system — “Clear Signal”: a teal signal on a quiet neutral workbench. Switch it site-wide from the admin panel; the interface recedes so the task stays in focus.</p>
                </div>
